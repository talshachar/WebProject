...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 60%; margin-left: auto; margin-right: auto">
        ...
        <br />
        <div style="border: thin solid #cccccc; padding: 30px; background: #efefef; display: inline-block; box-shadow: 1px 1px 7px #bbb">
            <div style="display: inline-block;">
                מס' תעודת זהות:<br />
        ...
        <div style="border: thin solid #cccccc; padding: 30px; background: #efefef; float: left; box-shadow: 1px 1px 7px #bbb">
            <div style="display: inline-block;">
                סיסמה חדשה:<br />
